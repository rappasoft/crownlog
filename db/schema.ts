...
export const watches = sqliteTable(
  "watches",
  {
    ...
    marketProvider: text("market_provider").notNull().default(""),
    marketModelId: text("market_model_id").notNull().default(""),
    marketModelName: text("market_model_name").notNull().default(""),
    ...
    marketConfidence: text("market_confidence").notNull().default(""),
    marketCurrency: text("market_currency").notNull().default("USD"),
    marketCheckedAt: text("market_checked_at"),
    marketCheckStatus: text("market_check_status").notNull().default(""),
    createdAt: text("created_at").notNull().default(sql`CURRENT_TIMESTAMP`),
